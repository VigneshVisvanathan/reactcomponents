...
export class Form extends Component {
    ...
    handleTopicsChange=(event)=>{this.setState({
    ...
    render() {
        ...
        return (
            ...
            <form onSubmit={this.handleSubmit}><div><label>Username</label>
            <input type='text' value={username} onChange={this.handleUsernameChange} /></div>
